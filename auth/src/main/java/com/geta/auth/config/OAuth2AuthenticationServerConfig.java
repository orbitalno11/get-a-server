package com.geta.auth.config;

import com.geta.auth.service.UserAuthDetailServiceImpl;
...
public class OAuth2AuthenticationServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    @Autowired
    private UserAuthDetailServiceImpl userDetailsService;
    ...
    public PasswordEncoder userPasswordEncoder() {
        return CustomPasswordEncoder.createBCryptEncoder();
    }
